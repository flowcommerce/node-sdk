...
const enums = {
  ...
  attributeIntent: ['brand', 'checkout_content', 'fulfillment_method', 'hazardous', 'price', 'taxability'],
  ...
  importType: ['harmonization_codes', 'catalog_items', 'customs_descriptions'],
