...
const enums = {
  ...
  attributeIntent: ['brand', 'color', 'countries_of_origin', 'product_id', 'fulfillment_method', 'hazardous', 'price', 'size', 'sku', 'taxability', 'consumer_url', 'gtin', 'mpn', 'excluded_regions', 'facet'],
