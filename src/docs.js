...
const readmeTemplate = handlebars.compile(fs.readFileSync(`${srcDir}/readme.handlebars`).toString('utf-8'));
const resourceTemplate = handlebars.compile(fs.readFileSync(`${srcDir}/resource.handlebars`).toString('utf-8'));
