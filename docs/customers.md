# [API](README.md).customers - Flow Commerce API - Node SDK Documentation
...
| number | [string] | Find customers by number |
| email | [string] | Find customers by email |
| phone | [string] | Find customers by phone |
